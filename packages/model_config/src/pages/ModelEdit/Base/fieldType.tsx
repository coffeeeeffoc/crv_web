...
export const fields: modelFormRightFieldsType[] = [
  {
    title: 'ID(数据库表名)',
    name: 'id',
    control: <InputWithLength placeholder='请输入 ID' disabled={true} maxLength={30}/>,
    itemProps: {}
  },
  {
    title: '名称',
    name: 'name',
    control: <InputWithLength placeholder='请输入 名称' maxLength={20} />,
    itemProps: {}
  },
  {
    title: '类型',
    name: 'type',
    control: (<Select placeholder='请选择 类型'>
  ...
  },
  {
    title: '所属模块',
    name: 'module',
    control: (<Select placeholder='请选择 所属模块'>
