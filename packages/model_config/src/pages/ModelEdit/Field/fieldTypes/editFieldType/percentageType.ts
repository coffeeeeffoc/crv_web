 ...
 * 货币
 */
import { ControlType, percentageShowTypeOption } from '../constants'
    ...
    [
      {
        ...
        itemProps: {
          rules: [
            ...
            { max: 62, min: 2, type: 'integer', message: '字段长度应为整数且大于等于2,小于等于62' }
          ],
    ...
    [
      {
        ...
        itemProps: { style: { paddingRight: '50px' }, initialValue: percentageShowTypeOption[0].value },
        config: {
          options: percentageShowTypeOption
        }
      },
      {
        control: INPUT_NUMBER,
