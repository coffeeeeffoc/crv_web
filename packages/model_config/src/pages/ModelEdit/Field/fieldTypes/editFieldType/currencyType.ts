 ...
 * 货币
 */
import { ControlType, currencyShowTypeOption } from '../constants'
    ...
    [
      {
        ...
        itemProps: { style: { paddingRight: '50px' }, initialValue: currencyShowTypeOption[0].value },
        config: {
          options: currencyShowTypeOption
        }
      },
      {
        control: INPUT_NUMBER,
