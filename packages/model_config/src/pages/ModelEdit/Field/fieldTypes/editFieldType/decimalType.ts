 ...
 * 小数
 */
import { ControlType, decimalShowTypeOption } from '../constants'
    ...
    [
      {
        ...
        itemProps: {
          rules: [
            ...
            { max: 64, min: 2, type: 'integer', message: '字段长度应为整数且大于等于2,小于等于64' }
          ],
    ...
    [
      {
        ...
        itemProps: { style: { paddingRight: '50px' }, initialValue: decimalShowTypeOption[0].value },
        config: {
          options: decimalShowTypeOption
        }
      },
      {
        control: INPUT_NUMBER,
