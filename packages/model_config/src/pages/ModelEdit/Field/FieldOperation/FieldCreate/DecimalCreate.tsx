...
const Decimal: FC<DataProps> = (props) => {
  const { fields } = props
        ...
        <Col span={12} style={{ ...FIELD_CONFIG_COL_STYLE, borderRight: '1px solid #fbfbfb' }}>
          {
            fields.left.map((field: any) => {
              ...
              // mount newProps to control, mount newItemProps to form.Item
              const newProps: any = {}
            ...
            fields.right.map((field: any) => {
              ...
              if (field.name === 'decimalDigits') {
                ...
                newItemProps.rules = [
                  ...
                  { min: 2, max: length > 30 ? 30 : length, type: 'integer', message: `小数位数应为整数且应大于等于2,小于等于${length > 30 ? 30 : '字段长度'}` }
                ]
              }
