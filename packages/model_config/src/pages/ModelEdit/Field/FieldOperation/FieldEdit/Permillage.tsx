                ...
                row.map((field: any, colIndex: number) => {
                  ...
                  if (field.name === 'decimalDigits') {
                    ...
                    newItemProps.rules = [
                      ...
                      { min: 2, max: currencyLength > 27 ? 27 : currencyLength, type: 'integer', message: `小数位数应为整数且应大于等于2,小于等于${currencyLength > 27 ? 27 : '字段长度'}` }
                    ]
                  }
                  // 小数位数的依赖关系
                  if (field.name === 'showDigits') {
                    ...
                    newItemProps.rules = [
                      { max: decimalDigits, type: 'integer', message: `显示小数位数应为整数且小于等于${decimalDigits < 27 ? '字段小数位数' : 27}` }
                    ]
                  }
