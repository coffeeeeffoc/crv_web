...
export const globalItem: ItemType[] = [
  { value: 'company', type: Type.GLOBAL_PARAM, description: '公司', name: '公司' },
  { value: 'duration', type: Type.GLOBAL_PARAM, description: '期间', name: '期间' },
  { value: 'user', type: Type.GLOBAL_PARAM, description: '用户', name: '用户' }
]

// 操作符的默认配置
export const operationItem: ItemType[] = [
  { value: '+', type: Type.OPERATE_SIGN, name: '加', description: '加' },
  { value: '-', type: Type.OPERATE_SIGN, name: '减', description: '减' },
  { value: '*', type: Type.OPERATE_SIGN, name: '乘', description: '乘' },
  { value: '/', type: Type.OPERATE_SIGN, name: '除', description: '除' },
  { value: '(', type: Type.OPERATE_SIGN, name: '左括号', description: '左括号' },
  { value: ')', type: Type.OPERATE_SIGN, name: '右括号', description: '右括号' },
  { value: '()', type: Type.OPERATE_SIGN, name: '括号', description: '括号' }
]

// 函数列表默认配置
export const functionItem: ItemType[] = [
  { value: '${}', type: Type.FUNCTION, description: '${}', name: '${}' },
